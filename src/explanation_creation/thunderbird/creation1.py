...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_path",
        type=str,
        default="/Users/kristian/Desktop/mt_dataset/agentic_ai/thunderbird/sampled_50_explained_30.json",
        help="Path to the input JSON dataset containing log sequences."
    )
    parser.add_argument(
        "--output_path",
        type=str,
        default="/Users/kristian/Desktop/mt_dataset/agentic_ai/thunderbird/sampled_50_explained.json",
        help="Path to save the output JSON dataset with explanations."
    )
    parser.add_argument(
        "--prompt_template_path",
        type=str,
        default="thunderbird/prompt1",
